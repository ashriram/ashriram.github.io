...
function get_years() {
  ...
  $.each(years, function(key, value) {
    $('.years').append(
        '<a href="#years" class="years_btn button" year="' + key + '">' + key +
  ...
  $('.years_btn').click(function() {
    ...
    (new BibtexDisplay())
        .displayBibtex(
            $('#bibtex_input').val(), $('#bibtex_display'), constraints);
  });
...
$(document).ready(function() {
  ...
  $('.abstractdata').hide();
  $('#bibtex_input')
      .load('{{ site.baseurl }}/public/bibtex/ashriram.bib', bibtex_js_draw);
  $('#bibtex_input')
      .load('{{ site.baseurl }}/public/bibtex/ashriram.bib', get_years);
});
